...
Keyboard.prototype = {
    ...
    _sendKeyEvent: function _sendKeyEvent(keysym, code, down) {
        if (down) {
    ...
    _handleKeyPressTimeout: function _handleKeyPressTimeout(e) {
    ...
    _handleAltGrTimeout: function _handleAltGrTimeout() {
        this._altGrArmed = false;
        clearTimeout(this._altGrTimeout);
        this._sendKeyEvent(_keysym2.default.XK_Control_L, "ControlLeft", true);
    },
    ...
    _checkAlt: function _checkAlt(e) {
        if (e.altKey) {
            return;
        }
